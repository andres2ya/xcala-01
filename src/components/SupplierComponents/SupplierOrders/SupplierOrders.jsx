      ...
      <div className="pcControlerScreen ">
        ...
        <div className="container-fluid tab-orders">
          <div className="row">
            ...
            <div 
            onClick={()=>this.changeOrderDisplay('sinAtender')}
            className={`col-4 ${orderDisplay==='sinAtender'?'col-selector-active':'col-selector'}  d-flex justify-content-center align-items-center`}>
              Sin atender
            </div>
            <div 
            onClick={()=>this.changeOrderDisplay('atendidos')}
            className={`col-4 ${orderDisplay==='atendidos'?'col-selector-active':'col-selector'} d-flex justify-content-center align-items-center`}>
              Atendidos
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-5 filterByConstumer-col  d-flex justify-content-start align-items-center">
              ...
              className="filterBox d-flex justify-content-end align-items-center">
                Agrupar<i className="icon-filterBox icon-filter centerVerticalAndHorizontal"/>
              </div>
            </div>
        ...
        :
        <div>
          <p className="noOrdersMsg">Aun no has recibido tu primer pedido.</p>
