  ...
  render() {
    ...
    return (
      <div className="pcControlerScreen ">
        ...
        <div className="container-fluid filtersContainer">
          <div className="row">
            ...
            <div className="col-7 col-stateFilter d-flex justify-content-end align-items-center">
              <div onClick={this.applyFilterByState} className="filterBox d-flex justify-content-end align-items-center">
        ...
        {/* TODO: Renderizar pedidos desde datos traidos de la DB... */}
        {vectorPedidos.map(pedido=>
          <OrderCard 
          idPedido={pedido.idPedido} 
          cancelarActivo={pedido.cancelarActivo} 
          cambiarDirActivo={pedido.cambiarDirActivo} 
          cambioDireccion={pedido.cambioDireccion} 
          tipoPago={pedido.tipoPago} 
          ultimoEstado={pedido.ultimoEstado} 
          casoActivo={pedido.casoActivo} 
          fecha={pedido.fecha} 
          proveedor={pedido.proveedor} 
          imagen={pedido.image} 
          costo={pedido.costo} 
          ganancia={pedido.ganancia} 
          precioDeVenta={pedido.precioDeVenta} 
